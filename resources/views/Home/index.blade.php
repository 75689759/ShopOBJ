...
<head>
    ...
    <script type="application/javascript" src={{asset("Home/AmazeUI-2.4.2/assets/js/jquery.min.js")}}></script>
    <script type="application/javascript" src={{asset("Home/AmazeUI-2.4.2/assets/js/amazeui.min.js")}}></script>

</head>

<body>
@include('Home.common.lyear')
<div class="banner">
    <!--轮播 -->
    ...
    <div class="slideall">
                    ...
                    <div class="category">
                        <ul class="category-list" id="js_climit_li">
                            <li class="appliance js_toggle relative first">
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img
                                                    src={{asset("Home/images/cake.png")}}></i><a class="ml-22"
                                                                                                 title="点心">点心/蛋糕</a>
                                    </h3>
                                    <em>&gt;</em></div>
                            ...
                            <li class="appliance js_toggle relative">
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img
                                                    src={{asset("Home/images/cookies.png")}}></i><a class="ml-22"
                                                                                                    title="饼干、膨化">饼干/膨化</a>
                                    </h3>
                                    <em>&gt;</em></div>
                                <div class="menu-item menu-in top">
                            ...
                            <li class="appliance js_toggle relative">
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img
                                                    src={{asset("Home/images/meat.png")}}></i><a class="ml-22"
                                                                                                 title="熟食、肉类">熟食/肉类</a>
                                    </h3>
                                    <em>&gt;</em></div>
                                <div class="menu-item menu-in top">
                            ...
                            <li class="appliance js_toggle relative">
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img
                                                    src={{asset("Home/images/bamboo.png")}}></i><a class="ml-22"
                                                                                                   title="素食、卤味">素食/卤味</a>
                                    </h3>
                                    <em>&gt;</em></div>
                                <div class="menu-item menu-in top">
                            ...
                            <li class="appliance js_toggle relative">
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img
                                                    src={{asset("Home/images/nut.png")}}></i><a class="ml-22"
                                                                                                title="坚果、炒货">坚果/炒货</a>
                                    </h3>
                                    <em>&gt;</em></div>
                                <div class="menu-item menu-in top">
                            ...
                            <li class="appliance js_toggle relative">
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img
                                                    src={{asset("Home/images/candy.png")}}></i><a class="ml-22"
                                                                                                  title="糖果、蜜饯">糖果/蜜饯</a>
                                    </h3>
                                    <em>&gt;</em></div>
                                <div class="menu-item menu-in top">
                            ...
                            <li class="appliance js_toggle relative">
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img
                                                    src={{asset("Home/images/chocolate.png")}}></i><a class="ml-22"
                                                                                                      title="巧克力">巧克力</a>
                                    </h3>
                                    <em>&gt;</em></div>
                                <div class="menu-item menu-in top">
                            ...
                            <li class="appliance js_toggle relative">
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img
                                                    src={{asset("Home/images/fish.png")}}></i><a class="ml-22"
                                                                                                 title="海味、河鲜">海味/河鲜</a>
                                    </h3>
                                    <em>&gt;</em></div>
                                <div class="menu-item menu-in top">
                            ...
                            <li class="appliance js_toggle relative">
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img
                                                    src={{asset("Home/images/tea.png")}}></i><a class="ml-22"
                                                                                                title="花茶、果茶">花茶/果茶</a>
                                    </h3>
                                    <em>&gt;</em></div>
                                <div class="menu-item menu-in top">
                            ...
                            <li class="appliance js_toggle relative last">
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img
                                                    src={{asset("Home/images/package.png")}}></i><a class="ml-22"
                                                                                                    title="品牌、礼包">品牌/礼包</a>
                                    </h3>
                                    <em>&gt;</em></div>
                                <div class="menu-item menu-in top">
        ...
        <div class="marqueen">
            ...
            <div class="demo">
                ...
                <div class="advTip"><img alt="" src={{asset("Home/images/advTip.jpg")}}/></div>
            </div>
        </div>
        <div class="clear"></div>
    </div>
    ...
    <div id="f2">
        ...
        <div class="am-g am-g-fixed floodThree ">
            ...
            <div class="am-u-sm-6 am-u-md-3 text-five ">
                <a href="# ">
                    <img src={{asset("Home/images/8.jpg")}} />
                    <div class="outer-con ">
                        <div class="title ">
                            雪之恋和风大福
                        </div>
            ...
            <div class="quick_toggle ">
                ...
                <li class="qtitem ">
                    ...
                    <div class="mp_qrcode " style="display:none; "><img
                                src={{asset("Home/images/weixin_code_145.png ")}} /><i class="icon_arrow_white "></i>
                    </div>
                </li>
                <li class="qtitem ">
...
<script>
    ...
    src ={{asset("Home/basic/js/quick_links.js ")}}>
</script>
</body>
