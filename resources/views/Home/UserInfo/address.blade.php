		...
		<div class="center">
			<div class="col-main">
				<div class="main-wrap">
						...
						<div class="am-modal am-modal-no-btn" id="doc-modal-1">
							...
							<div class="add-dress">
								...
								<div class="am-u-md-12 am-u-lg-8" style="margin-top: 20px;">
									<form method="post" action="{{ route('addaddress') }}" class="am-form am-form-horizontal" id="zhangdiandian">
										{{ csrf_field() }}
										...
										<div class="am-form-group">
											<div class="am-u-sm-9 am-u-sm-push-3">
												<button id="submit" type="submit" class="am-btn am-btn-danger">保存</button>
					...
					// var FormData = new FormData($('#zhangdiandian')[0]);
